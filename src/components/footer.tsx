        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-white/70 mb-6 max-w-md">
              The ultimate platform for hackathons, networking, and talent discovery. 
          ...
          {/* For Organizations */}
          <div>
            <h3 className="text-white font-semibold mb-6">For Organizations</h3>
            <ul className="space-y-4">
              <li><Link href="/signup?role=sponsor" className="text-white/70 hover:text-white transition-colors">HackMate for Sponsors</Link></li>
              <li><Link href="/signup?role=recruiter" className="text-white/70 hover:text-white transition-colors">HackMate for Recruiters</Link></li>
              <li><Link href="/signup?role=organizer" className="text-white/70 hover:text-white transition-colors">Host an Event</Link></li>
              <li><Link href="/partnerships" className="text-white/70 hover:text-white transition-colors">Partnerships</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link href="/status" className="text-white/70 hover:text-white transition-colors">Status</Link></li>
