        ...
        <section id="features" className="py-20 bg-muted/50">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                    <FeatureListItem icon={<BrainCircuit size={24} />} title="AI-powered Team Matching" description="Our algorithm suggests the best collaborators based on skills, experience, and project interests."/>
                    <FeatureListItem icon={<UserCheck size={24} />} title="Dynamic Profiles" description="Showcase your projects, skills, and hackathon history to stand out to recruiters and teammates."/>
                    <FeatureListItem icon={<Code size={24} />} title="Event Code Join System" description="A simple, secure 6-character code is all participants need to join your event instantly."/>
                    <FeatureListItem icon={<Settings size={24} />} title="Organizer Tools" description="Manage participants, send announcements, and track team progress from a centralized dashboard."/>
                    <FeatureListItem icon={<MessageSquare size={24} />} title="Post-event Networking" description="Keep the connections going. Follow users, message your team, and see who you'll meet at the next event."/>
                    <FeatureListItem icon={<Trophy size={24} />} title="Participant Achievements" description="Earn badges for participation, winning, and specific skills, building your credibility in the community."/>
                </div>
            </div>
        </section>
