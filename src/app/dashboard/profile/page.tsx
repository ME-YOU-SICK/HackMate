...
import { Github, Linkedin, Twitter, Save } from "lucide-react";
                ...
                <div className="lg:col-span-1 space-y-8">
                     <Card className="bg-card/60 backdrop-blur-lg border-border/50">
                        <CardHeader className="items-center text-center">
                            ...
                            <CardTitle className="font-headline text-3xl">Ada Lovelace</CardTitle>
                            <CardDescription>Software Engineer & AI Enthusiast</CardDescription>
                            <div className="flex gap-4 pt-4">
                                <Link href="#" passHref><Button variant="outline" size="icon"><Twitter className="h-4 w-4"/></Button></Link>
                                <Link href="#" passHref><Button variant="outline" size="icon"><Linkedin className="h-4 w-4"/></Button></Link>
                                <Link href="#" passHref><Button variant="outline" size="icon"><Github className="h-4 w-4"/></Button></Link>
                            </div>
                        </CardHeader>
                    </Card>
